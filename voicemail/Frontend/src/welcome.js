...
class Welcome extends React.Component {
    ...
    render() {
        ...
        if (this.state.initial === true) {
            ...
            this.text2speech("Welcome To Your Voicemail System. Please hit the spacebar to listen voice assistant")
        } 
        ...
        return (
            ...
            <div className="page">  
                ...
                <div className="header">
                    <h2>Welcome To Your Voicemail System</h2>
                </div>
                        ...
                        <form onSubmit={this.handleLoginSubmit}>
                            ...
                            <div className="form-group">
                                <div className="btn-group btn-group-block">
                                    <button className="btn btn-success btn-block" type="submit" value="Submit">Login</button>
                                </div>
                            </div>
                        </form>
