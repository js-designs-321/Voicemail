...
class Email extends React.Component {
    ...
    get_emails() {
        // Axios.post("http://localhost:8080/email/fetch_emails", {"search": "INBOX"}).then((req) => {
        ...
        this.setState({
            InboxMails: [{
                "subject":"Hello world",
                "target":"abc2@gmail.com",
                "message":"Hi my name is sujay"
            }]
        })
    }
    ...
    handleEnd(err, text) {
        ...
        if (this.state.inboxEmail === true) { //When the user wants to listen any inbox mail
            ...
            if (option.toLowerCase() === "menu") {  //If users says the menu keyword, voice assistant tells the menu options
                ...
                const mapStringNumberToNumericNumber = {
                    "one":1
                }
                if(!isNaN(mapStringNumberToNumericNumber[option])) {        //When the user says the index of the mail, voice assistant tells the content of the selected mail
          ...
          <div className="flex-centered">
              ...
              <div className="app_div">
                  ...
                  <div className="header_section">
                      <p className="header_title">Voicemail System</p>
                  </div>
